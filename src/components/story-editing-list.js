...
const StoryEditingList = () => (
    <div id="story-editing-list" className='mt-5'>
        ...
        <div id="story-editing-list-content">
            ...
            <h5 className="story-title mt-5 mb-3"><strong>As Nutayunean, We Still Live Here</strong></h5>
            <p className="story-content mb-3">
            ...
            <h5 className="story-title mt-5 mb-3"><strong>Rebels With A Cause</strong></h5>
            <p className="story-content mb-3">
            ...
            <h5 className="story-title mt-5 mb-3"><strong>Tribal Justice</strong></h5>
            <p className="story-content mb-3">
            ...
            <h5 className="story-title mt-5 mb-3"><strong>Chasing Voices</strong></h5>
            <p className="story-content mb-3">
            ...
            <h5 className="story-title mt-5 mb-3"><strong>Sansón and Me</strong></h5>
            <p className="story-content mb-3">
