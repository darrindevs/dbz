...
const StoryEditingList = () => (
    <div id="story-editing-list" className='mt-5'>
        ...
        <div id="story-editing-list-content">
            ...
            <a className="mb-3" href="https://www.hokanmedia.com/chasingvoices" target="blank">link</a>
            ...
            <a className="mb-3" href="https://www.makepeaceproductions.com/tribaljustice/" target="blank">link</a>
            {/* Story */}
            ...
            <a className="mb-3" href="http://rebelsdocumentary.org/" target="blank">link</a>
            {/* Story */}
            ...
            <a className="mb-3" href="http://www.makepeaceproductions.com/wampfilm.html" target="blank">link</a>
            {/* Story */}
            ...
            <a className="mb-3" href="http://www.emilenorman.com/pbsdoc.html" target="blank">link</a>
        </div>
    </div>
  );
