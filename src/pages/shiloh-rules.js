      ...
      <Col lg={{ span: 6, offset: 0 }}>
        <div className='play-content mb-5'>
          ...
          <p className="play-meta mt-3"><strong>Development: </strong>Taper New Works Festival, LA CA., Intiman Theater Reading Series, Seattle WA. Hedgebrook Residency, Whidbey Island, WA.</p>
            ...
            <p className="play-meta mt-3"><strong>Publisher: </strong><a href="https://www.playscripts.com/play/1802#:~:text=Set%3A%20One%20set%2C%20various%20areas,Female%20Reenactor%20of%20the%20Year" target="__blank"> Playscripts Inc.</a></p>
